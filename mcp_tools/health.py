...
_WORKFLOW_GUIDE = {
    ...
    "tool_index": {
        ...
        "pipeline_tools": {
            ...
            "run_normalisation_imputation": "Run normalisation + imputation for one upload. Prefer run_normalisation_imputation_bulk for many uploads.",
            ...
            "run_pairwise_comparison": "Run limma pairwise differential analysis for one upload. Prefer run_pairwise_comparison_bulk for many.",

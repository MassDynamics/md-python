...
def run_dose_response(
    ...
    # Platform default (DoseResponseParams in data-set-service): False.
    # Keep MCP default aligned.
    ...
    use_imputed_intensities      False      False (only observed values, platform
                                            default) | True (use NI-imputed values)
...
def _submit_dr_job(
    ...
    try:
        ...
        run_result = run_dose_response(
            ...
            use_imputed_intensities=job.get("use_imputed_intensities", False),

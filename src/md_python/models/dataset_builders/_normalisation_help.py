...
_LINES = [
    ...
    "  Optional core:",
    "    entity_type: protein | peptide | gene | metabolite | ptm  (default",
    "      protein; wire format is lowercase. Metabolite NI is upstream-gated.)",
    ...
    "  ptm:         skip | by missing values | by ptm localization probability",

...
def ds(state: str, id_str: str = "11111111-1111-1111-1111-111111111111") -> Dataset:
    return Dataset(input_dataset_ids=[], name="n", job_slug="j", job_run_params={}, state=state, id=UUID(id_str))
...
class TestDatasetsWait:
    ...
    def test_wait_until_complete_success(self, res, mocker):
        ...
        out = res.wait_until_complete("exp-1", "11111111-1111-1111-1111-111111111111", poll_s=0, timeout_s=1)
    ...
    def test_wait_until_complete_failure(self, res, mocker):
        ...
        with pytest.raises(Exception):
            res.wait_until_complete("exp-1", "11111111-1111-1111-1111-111111111111", poll_s=0, timeout_s=1)

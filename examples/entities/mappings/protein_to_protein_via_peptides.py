"""
Example of mapping protein groups to protein groups via peptides using the MD Python client
"""
...
def protein_to_protein_via_peptides_example():
...
if __name__ == "__main__":
    protein_to_protein_via_peptides_example()
